...
<!-- Projects Section-->
<section  id="post-<?php the_ID(); ?>" <?php post_class('practice-single-section section-padding-default'); ?>>
	<div class="default-container ex-padding-01">
		<div class="row clerfix">
			<div class="<?php echo esc_attr( $lawgit_layout_class );?> <?php echo esc_attr( $lawgit_sidebar_class );?>">
    			<div class="practice-single-details">
					<?php while ( have_posts() ) : the_post(); ?>
						<?php get_template_part( 'template-parts/content-single', 'practice' );?>
						<?php
